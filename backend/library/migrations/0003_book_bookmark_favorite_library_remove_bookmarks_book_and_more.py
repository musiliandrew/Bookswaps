        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "author",
                    models.CharField(
                        db_comment="Author(s), comma-separated or JSON", max_length=255
                    ),
                ),
                (
                    "year",
                ...
                (
                    "genre",
                    models.CharField(
                        blank=True, db_comment="Book genre", max_length=100, null=True
                    ),
                ),
                (
                    "isbn",
                    models.CharField(
                        blank=True,
                        db_comment="ISBN-10 or ISBN-13",
                        max_length=13,
                        null=True,
                        unique=True,
                        validators=[backend.library.models.validate_isbn],
                    ),
                ),
                (
                    "cover_image_url",
                    models.URLField(
                        blank=True,
                        db_comment="Cover image URL (Open Library or S3)",
                        max_length=500,
                        null=True,
                        validators=[backend.library.models.validate_cover_image_url],
                    ),
                ),
                (
                    "qr_code_url",
                ...
                (
                    ...
                    models.BooleanField(
                        db_comment="True if available for swapping", default=True
                    ),
                ),
                (
                    "available_for_borrow",
                    models.BooleanField(
                        db_comment="True if available for borrowing", default=True
                    ),
                ),
                (
                    "condition",
                ...
                (
                    "synopsis",
                    models.TextField(blank=True, db_comment="Book summary", null=True),
                ),
                (
                    "copy_count",
                    models.IntegerField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_comment="Prevents re-swaps during cooldown",
                        null=True,
                    ),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, db_comment="When book was added"
                    ),
                ),
                (
                    "updated_at",
                    models.DateTimeField(
                        auto_now=True, db_comment="When book was last updated"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notify_on_available",
                    models.BooleanField(
                        db_comment="Notify user when book becomes available",
                        default=False,
                    ),
                ),
                (
                    "active",
                    models.BooleanField(
                        db_comment="True if bookmark is active", default=True
                    ),
                ),
                (
                    "notified_at",
                    models.DateTimeField(
                        blank=True,
                        db_comment="When availability notification was sent",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.TextField(
                        blank=True, db_comment="Why the book was favorited", null=True
                    ),
                ),
                (
                    "active",
                    models.BooleanField(
                        db_comment="True if favorite is active", default=True
                    ),
                ),
                (
                    "notified_on_match",
                    models.BooleanField(
                        db_comment="Notify user on matching recommendations",
                        default=False,
                    ),
                ),
                (
